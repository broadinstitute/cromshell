...
from cromshell.utilities.cromshellconfig \
    import config_dir, CROMSHELL_CONFIG_FILE_NAME, __load_cromshell_config_file, cromwell_server
...
def test_update_server():
    ...
    with runner.isolated_filesystem():
        ...
        print(f"After attempting to update to '{test_server_name}', "
