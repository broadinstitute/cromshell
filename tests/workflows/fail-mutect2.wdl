version 1.0
######
## Obtained from https://github.com/broadinstitute/gatk/blob/master/scripts/mutect2_wdl/mutect2.wdl 04/25/2022
## To be used for testing
## WDL Complexity Medium: >10 tasks, includes scatters
######
...
task M2 {
    ...
    command <<<
        ...
        gatk --java-options "-Xmx~20m" Mutect2 \ # memory should cause failure
            -R ~{ref_fasta} \
            $tumor_command_line \
            $normal_command_line \
